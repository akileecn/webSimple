<div class="container">
	<form action="<@spring.url "/resume/save/base"/>" method="post">
<#assign fields=[
	...
	,["date","joinPartyDate","入党时间"],["text","mobile","手机"],["text","email","邮箱"],["text","highestEducation","最高学历"],["select","highestDegree","最高学位"]
