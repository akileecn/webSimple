...
<#if recruitType=="society">
	<#-- 工作实习经历 -->
	<@subpage1 name="work" title="工作实习经历" required=true>
...
<#if recruitType=="campus">
	...
	<@subpage2 name="practice">
		...
		<@textarea label="职责" name="duty" required=true/>
	</@subpage2>
	<#-- 学生干部 -->
	...
	<@subpage2 name="studentCadre">
		...
		<@date label="结束时间" name="endDate" required=true/>
		<@select label="级别" name="level" dict="cadreLevel" required=true/>
		</tr><tr>
		<@textarea label="职责描述" name="description" required=true/>
	</@subpage2>
</#if>
<#-- 奖励记录 -->
<@subpage1 name="award" title="奖励记录(填写在校或工作期间获奖情况)">
...
<@subpage2 name="train">
	...
	<@input label="培训机构" name="company" required=true/>
	<@input label="培训地点" name="place" required=true/>
	</tr><tr>
	<@input label="培训课程" name="course" required=true wide=true/>
	</tr><tr>
	<@textarea label="详细描述" name="description" required=true/>
</@subpage2>
<#-- 家庭成员 -->
